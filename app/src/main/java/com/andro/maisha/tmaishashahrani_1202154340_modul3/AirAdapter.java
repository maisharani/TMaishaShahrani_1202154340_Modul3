 ...
 */
class AirAdapter extends RecyclerView.Adapter<AirAdapter.SportsViewHolder>  {
     ...
     */
    AirAdapter(Context context, ArrayList<Air> sportsData) {
    ...
    public void onBindViewHolder(SportsViewHolder holder, int position) {
        ...
        Air currentSport = mSportsData.get(position);
    ...
    static class SportsViewHolder extends RecyclerView.ViewHolder
        ...
        SportsViewHolder(Context context, View itemView, GradientDrawable gradientDrawable) {
            ...
            mSportsImage = (ImageView)itemView.findViewById(R.id.airImage);
        ...
        public void onClick(View view) {
            ...
            Intent detailIntent = Air.starter(mContext, mCurrentSport.getTitle(),
